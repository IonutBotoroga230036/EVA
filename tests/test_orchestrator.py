...
def test_builtin_wins_name_collision(tmp_path):
    ...
    assert b.by_name["get_weather"]["function"]["description"].startswith("Get real current weather")
...
def fake_ollama(decisions, answer, extracted=()):
    seen = {"decisions": 0, "extract": 0}
