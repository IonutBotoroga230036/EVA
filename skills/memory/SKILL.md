...
enabled: true
trusted: true
triggers: ["remember", "forget", "from now on", "what do you know about me", "do you remember"]
permissions:
  network: []
...
you know or remember. Use forget_memory when they ask you to forget something.
